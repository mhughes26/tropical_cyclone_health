...
*[BA: I think we want to talk about this as it's own thing. Even though it sometimes
is related to the idea of exposure misclassification, it's got some other facets, like 
that you're losing information by taking a continuous measurement and lumping it into
two groups.]*
...
winds during the storm above a certain threshold (e.g., gale-force winds or higher).

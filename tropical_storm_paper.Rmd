...
Non-differential misclassification refers to misclassification of either the exposure or the outcome, that is unrelated to the other [@aschengrau2013essentials]. Environmental epidemiology studies are often prone to non-differential misclassification error, which will often, though not always bias the results towards the null [@armstrong1998effect]*. In effect, this will weaken or obscure any associations that are present that the researcher may hope to observe in the
...
What determines the category that a hurricane is classified as, is the maximum sustained surface wind speed, which is defined as the peak one minute wind speed at a height of 10 feet over an unobstructed exposure [@taylor2010saffir]. An important limitation of the Saffir-Simpson scale to consider is that it doesn't take into account other hurricane-related impact variables such as storm surges, flooding, and tornadoes [@taylor2010saffir]. 

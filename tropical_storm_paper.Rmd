...
at they near and cross communities in the United States. This data can come
...
exposure and human impacts. When studying the econonomic, social, and health
...
One pathway for problems is through misclassification / measurement error bias.
Failure to classify exposure accurately allows misclassification bias to move
the results of the study further from the true parameter (for example,
classifying certain observations as exposed to a storm when they really 
were not, or vice-versa). [Add a clarification of misclassification error 
...
Environmental epidemiology studies are often
prone to non-differential misclassification error, which will [in all
...
data [@armstrong1998effect]. [Add an example from tropical cyclone impacts

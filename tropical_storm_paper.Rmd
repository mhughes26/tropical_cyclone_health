...
Differential misclassification error occurs when the misclassification of the outcome depends on the misclassification of the exposure or vice versa [@aschengrau2013essentials]. Unlike non-differential misclassification, which often has the effect of moving the observed association or parameter towards the null, differential misclassification can move the observation in either direction. An example of differential misclassification in tropical cyclone impact studies can occur in self reported data such as in [@lieberman2017self] where study subjects were asked to report their own flooding exposure and also mental health symptoms of depression, anxiety, and PTSD. It is reasonable to believe that self perceived exposure to hurricane related flooding would also be associated with perceived negative mental health symptoms and thus contribute to differential misclassification error in this situation. 
...
Point locations are the smallest resolution of spatial data used to assess the exposure to tropical storms and hurricanes, as they represent the specific location
of individual, non-aggregated observations on the outcome of interest. The obvious advantage of a point location is that when mapped it can be overlayed with physical exposure data on a storm or storms to gage a very accurate picture of exposure, 
taking full advantage of high resolution in the exposure data. Since storm tracks are often spatially represented by the path of storm's center, having point locations for the exposed units of interest means that you can more accurately measure how close each observation was to the storm's central track, and then further make conclusions based on this. Similarly, point locations can be 
